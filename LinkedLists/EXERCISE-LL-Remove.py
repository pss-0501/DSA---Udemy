...
class LinkedList:
    ...
    def remove(self, index):
        ...
        if index == self.length:
            return self.pop()
        pre = self.get(index-1)     # remove node 2 i.e value 3; pre = val 2
        temp = pre.next             # temp = val 3; i.e value to be removed
        pre.next = temp.next        # assign node 2 to node 4; i.e remove 3
        temp.next = None            # making node 
        self.length -= 1   
        return temp
